...
|-------|------|----------------------|
| **EBANX set as Brazil primary** | Nov 2 | Happened 4 weeks before the crash. Auth rates were stable at ~83% through Nov 16. The routing change itself is not the cause — it's what makes EBANX the primary surface area for this failure. |
| **StreamVibe checkout UI update** | Oct 31 | 3+ week gap before any rate change. Hard decline codes (14, 54) are flat. |
| **PIX enablement in Brazil** | Nov 8 | PIX is performing at 93% AR, stable. No effect on card routing or issuer authentication. |
| **Banco do Brasil maintenance window** | Nov 20-21 | Marked complete. All other issuers declined at the same rate as BdB. dLocal shows 82.7% AR on BdB BINs. May have surfaced the EBANX latency issue but is not the cause. |
| **Argentina auth rate "terrible for weeks"** | Ongoing | At market floor for 8 weeks, not actively worsening. Not a crisis — it's a ceiling. |

---

## 6. Key Metrics & Tables to Use as Evidence in Final RCA

1. **Brazil Cards by Acquirer** → EBANX 54.6% vs. dLocal 82.7% — rules out all market/issuer explanations
2. **Error Code Distribution (EBANX)** → Code 91: 412 → 3,825 (+829%) — the definitive evidence
...
5. **Incident Timeline** → Nov 15 upgrade → Nov 21 collapse (5-day lag)
6. **Brazil by Payment Method** → PIX/Boleto healthy — crisis is cards-only
7. **Argentina by Payment Method** → wallet (66%) healthy, cards at benchmark

### Revenue Impact Quantification
- Lost EBANX approvals: 13,440 × (83.1% - 54.6%) = **~3,831/month**
- Net loss (after dLocal recovery): **~3,744 approvals/month**
- Conservative revenue impact: **~$37,400/month** (avg ticket $9.99 monthly plan)
- Blended revenue impact (70% monthly / 30% annual): **~$127,000/month**
